...
public class I18nResult<T> extends Result<T> {
	...
	public static <T> I18nResult<T> of(String objectName, String codes, String... args) {
		return new I18nResult<T>(Result.VALIDATOR).addField(objectName, codes, args);
	}
	
	public static <T> I18nResult<T> ofObjs(String objectName, String codes, Object... args) {
		return new I18nResult<T>(Result.VALIDATOR).addFieldObjs(objectName, codes, args);
	}
	...
	public I18nResult<T> addField(String objectName, String code, String... args) {
		Object[] objs = new Object[args.length];
		for (int i = 0; i < args.length; i++) {
			objs[i] = new DefaultMessageSourceResolvable(args[i]);
		}
	...
	public I18nResult<T> addFieldObjs(String objectName, String code, Object... args) {
		fields.add(new ObjectError(objectName, new String[] { code }, args, objectName));
		return this;
	}
	...
	public String toString() {
		return "I18nResult [code=" + code + ", args=" + Arrays.toString(args) + ", fields=" + fields + "]";
	}
