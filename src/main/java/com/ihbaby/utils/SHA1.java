...
public class SHA1 {
	...
	public static void main(String[] args) {
		// String data =
		// "jsapi_ticket=sM4AOVdWfPE4DxkXGEs8VLYCYJcSpy27c8DCFIHXmgu7mhXfQAWLXvod8gproZOuP1Qvp8nxAGjuY_jiu01uhA&noncestr=hanzaixiongmao&timestamp=1423551463&url=http://wx.viglle.com:8080/hanzai/hanhou.htm";
		
		String p1 = "6542D3284D0AD79A58928937F613520F";
		String p2 = "";
		String p3 = "";
		String p4 = "";
		String p5 = "";
		String target = p1 + p2 + p3 + p4 + p5;
		
		// System.out.println(target);
		String digest = "";
		try {
			digest = new SHA1().getDigestOfString(target.getBytes("UTF-8"));
